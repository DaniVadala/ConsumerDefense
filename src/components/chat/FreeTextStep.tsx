  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-lg mx-auto px-1 py-2">
      <div className="flex flex-col gap-1">
        <h2 className="text-lg sm:text-base font-semibold text-gray-900">Contanos qué pasó</h2>
      ...
      <p className="text-sm sm:text-xs text-gray-400 text-center">Podés escribir todo junto — detectamos automáticamente los datos.</p>
    </div>
  );
}
